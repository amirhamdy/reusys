                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                                        ...
                                        <tr>
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top;">
                                                ---c_name--- ---c_email--- ---c_address--- ---c_phone--- ---c_city--- ---c_country---
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                    ...
                    <td>
                        <table width="580" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                            ...
                            <tr>
                                ...
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 14px;  vertical-align: top; padding:5px 0;"><small>---p_source---</small></td>
                            </tr>
                            <tr>
                                <td height="1" colspan="4" style="border-bottom:1px solid #e4e4e4"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 14px;  vertical-align: top; padding:5px 0;"><small>---p_target---</small></td>
                            </tr>
                            <tr>
                                <td height="1" colspan="4" style="border-bottom:1px solid #e4e4e4"></td>
                            </tr>
                            <tr>
                                ...
                                <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 14px;  vertical-align: top; padding:5px 0;"><small>---p_po---</small></td>
                            </tr>
                            <tr>
                                <td height="1" colspan="4" style="border-bottom:1px solid #e4e4e4"></td>
                            </tr>
