            ...
            <div class="flex">
                ...
                @auth
                    ...
                    <x-nav-dropdown title="Apps" align="right" width="48">
                            ...
                            @endcan
                            @can('view-any', App\Models\Productline::class)
                            <x-dropdown-link href="{{ route('productlines.index') }}">
                            Productlines
                            </x-dropdown-link>
                            @endcan
                            @can('view-any', App\Models\Pricebook::class)
                            <x-dropdown-link href="{{ route('pricebooks.index') }}">
                            Pricebooks
                            </x-dropdown-link>
                            @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('home')" :active="request()->routeIs('home')">
                ...
                @endcan
                @can('view-any', App\Models\Productline::class)
                <x-responsive-nav-link href="{{ route('productlines.index') }}">
                Productlines
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Pricebook::class)
                <x-responsive-nav-link href="{{ route('pricebooks.index') }}">
                Pricebooks
                </x-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Project::class)
