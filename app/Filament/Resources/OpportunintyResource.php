...
use App\Filament\Resources\OpportunintyResource\Pages;

class OpportunintyResource extends Resource
{
    protected static ?string $model = Opportuninty::class;
    ...
    {
        return [
            'index' => Pages\ListOpportuninties::route('/'),
            'create' => Pages\CreateOpportuninty::route('/create'),
            'edit' => Pages\EditOpportuninty::route('/{record}/edit'),
        ];
    }
}
